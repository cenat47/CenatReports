...
from src.utils.email_sender import send_report_ready_email, send_role_change_email, send_verification_email
...
def send_role_change_email_task(admin_email: str, target_email: str, new_role: str, code: str):
